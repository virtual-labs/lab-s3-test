	...
	?>
		<div class="row">
			<form class="form-horizontal" action="submitform.php" method="POST" onsubmit="return validate()" role="form" enctype="multipart/form-data">
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="email" align="right">Band value:</label>
					<div class="col-sm-6">
		               	<select name="band" id="sub_groups" required>
			               	<option value="" selected="selected">Select</option>
				...
				<div class="form-group">
					<label class="control-label col-sm-4" for="text" align="right">Threshold</label>
					<div class="col-sm-4">
					<input type="number" name="titre" min='0.02' value='0.02' id="titre"/>
					</div>
				</div>

				<div class="form-group">
					<label class="control-label col-sm-4" for="text" align="right">Direction:</label>
					<div class="col-sm-4">
						<select id="direction" name="direction" onchange="changeValue(this);">
							<option value="">Choose</option>
