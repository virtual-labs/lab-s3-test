...
<script type="text/javascript">
            function changeValue(dropdown) {
                ...
                field1 = document.getElementById('titre1');
		    ...
		    field1.value=0;
                ...
                } else if (option == 'Standard Deviation') {
		    ...
		    field1.value=0;
                ...
                else if (option == 'Histogram Equalization') {
                	field.readOnly = true;
                	field1.readOnly = true;
		        field.value=0;
		    	field1.value=0;
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<select id="format" name="format" onchange="changeValue(this);">
		                    ...
		                    <option value="Logrithmic">Logrithmic</option>
		                    <option value="Exponantional">Exponantional</option>
		                    <option value="Decorrelation">Decorrelation</option>
                		</select>
					</div>
				</div>
				<div class="form-group">
					...
					<input type="number" name="titre1" id="titre1"/>
					</div>
				</div>
