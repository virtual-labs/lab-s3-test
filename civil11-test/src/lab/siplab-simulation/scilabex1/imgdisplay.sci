...
function img=imgdisplay(fname,RGB,subsetrow,subsetcol,win4pix)
...
imwrite(img,'out_original_img.jpg');
...
//imhist(img(:,:,i),255,'');
      ...
      xs2jpg(gcf(),"out_hist_band "+string(RGB(i))+".jpg");
...
//imhist(img,255,'');
      ...
      xs2jpg(gcf(),"out_hist_band "+string(RbandVal)+".jpg");
